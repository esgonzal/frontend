...
import { DetalleCursoScreenComponent } from './Screens/detalle-curso-screen/detalle-curso-screen.component';
...
const routes: Routes = [
  ...
  {path:'cursos/:id',component:CursoNuevoScreenComponent, children: [{path:'cursoIndividual/:idcurso',component:CursoNuevoIndividualScreenComponent}]},
